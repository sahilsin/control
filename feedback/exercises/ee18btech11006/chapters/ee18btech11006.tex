...
\text{or, }     \abs{k}  &>  0.008
\end{align}
%\item Verify your result using the PM.
%\\
%\solution The gain crossover frequency $\omega_{gc}$ is defined as 
%\begin{align}
...
%%
%\begin{align}
%PM=\phi_m=180^{\circ}+\angle{L\left(j\omega_{gc}\right)}&>0 
%\\
%\implies 180^{\circ}-3tan^{-1}\left({\frac{\omega_{gc}}{10^4}}\right)>0
%\\
