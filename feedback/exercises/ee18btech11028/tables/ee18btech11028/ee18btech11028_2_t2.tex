...
\hhline{|--|}
	...
	&\multicolumn{1}{p{\gnumericColB}|}%
	{\gnumericPB{\centering}$ 100 M \ohm$}
...
\hhline{|--|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	{\gnumericPB{\centering}$R_{p1}$}
	&\multicolumn{1}{p{\gnumericColB}|}%
	{\gnumericPB{\centering}$1000  \ohm$  }
...
\hhline{|--|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	{\gnumericPB{\centering}$C_{p1}$}
	&\multicolumn{1}{p{\gnumericColB}|}%
	{\gnumericPB{\centering}$100 \mu$F}
