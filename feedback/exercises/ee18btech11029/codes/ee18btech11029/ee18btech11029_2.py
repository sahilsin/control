...
#These are the values of poles before compensation
p1 = (2*np.pi*1e5)
p2 = (2*np.pi*1e6)
p3 = (2*np.pi*2*1e6)
...
plt.axvline(x = 8e7,ymin=0,color='k',linestyle='dashed')
plt.title("Uncompensated system")
plt.grid() 
...
plt.axvline(x = 1e7,ymin=-180,color='k',linestyle='dashed')
plt.grid()
...
# if using termux
plt.savefig('./figs/ee18btech11029/ee18btech11029_2.pdf')
plt.savefig('./figs/ee18btech11029/ee18btech11029_2.eps')
subprocess.run(shlex.split("termux-open ./figs/ee18btech11029/ee18btech11029_2.pdf"))
#else
#plt.show()
