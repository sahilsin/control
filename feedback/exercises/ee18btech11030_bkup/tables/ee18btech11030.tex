...
\hhline{|-|-|-|}
	...
	{\gnumericPB{\centering}\textbf{Q-Factor}}
	&\multicolumn{1}{p{\gnumericColB}|}%
	{\gnumericPB{\centering}\textbf{K}}
	&\multicolumn{1}{p{\gnumericColC}|}%
	{\gnumericPB{\centering}\textbf{Requirement}}
...
\hhline{|-|-|-|}
	...
	&\multicolumn{1}{p{\gnumericColC}|}%
	{\gnumericPB{\centering}Poles are coincident}

\\
\hhline{|-|-|-|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	{\gnumericPB{\centering}0.707}
	&\multicolumn{1}{p{\gnumericColB}|}%
	{\gnumericPB{\centering}0.686}
	&\multicolumn{1}{p{\gnumericColC}|}%
	{\gnumericPB{\centering}Maximally flat response}	
\\
\hhline{|-|-|-|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	{\gnumericPB{\centering}$\infty$}
	&\multicolumn{1}{p{\gnumericColB}|}%
	{\gnumericPB{\centering}2.1}
	&\multicolumn{1}{p{\gnumericColC}|}%
	{\gnumericPB{\centering}Oscillatory response}
	\\
