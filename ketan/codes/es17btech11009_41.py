...
#if using termux
plt.savefig('./figs/es17btech11009_41.pdf')
plt.savefig('./figs/es17btech11009_41.eps')
subprocess.run(shlex.split("termux-open ./figs/es17btech11009_41.pdf"))
#else
#plt.show()