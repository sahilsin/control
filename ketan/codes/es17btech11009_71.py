...
gain = 1				
num = [0,1000,12000,35000]
char_eq = [1,16,86,176,1105]
zeros=np.roots(num)
...
#if using termux
plt.savefig('./figs/es17btech11009_71.pdf')
plt.savefig('./figs/es17btech11009_71.eps')
subprocess.run(shlex.split("termux-open ./figs/es17btech11009_71.pdf"))
#else
#plt.show()