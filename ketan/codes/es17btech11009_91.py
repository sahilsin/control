...
#if using termux
plt.savefig('./figs/es17btech11009_91.pdf')
plt.savefig('./figs/es17btech11009_91.eps')
subprocess.run(shlex.split("termux-open ./figs/es17btech11009_91.pdf"))
#else
#plt.show()