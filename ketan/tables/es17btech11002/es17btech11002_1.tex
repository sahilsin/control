...
\hhline{|-|-|-|-}
	...
	{\gnumericPB{\centering}\gnumbox{\textbf{TERM}}}
	&\multicolumn{1}{p{\gnumericColB}|}%
	{\gnumericPB{\raggedright}\gnumbox[l]{\textbf{Corner Freq}}}
	&\multicolumn{1}{p{\gnumericColC}|}%
	{\gnumericPB{\raggedright}\gnumbox[l]{\textbf{Slope}}}
	&\multicolumn{1}{p{\gnumericColD}|}%
	{\gnumericPB{\raggedright}\gnumbox[l]{\textbf{Slope change}}}
\\
\hhline{|----|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	{$\brak{\j\omega}^2$}
...
\hhline{|----|}
	...
	{$\frac{1}{{1+\j0.2}}$}
	&\multicolumn{1}{p{\gnumericColB}|}%
	{$\omega_{c1}= \frac{1}{0.2}$}
	&\multicolumn{1}{p{\gnumericColC}|}%
	{\gnumericPB{\centering}\gnumbox{-20}}
	&\multicolumn{1}{p{\gnumericColD}|}%
	{\gnumericPB{\raggedright}\gnumbox[l]{40-20=20}}
\\
\hhline{|----|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	{$\frac{1}{{1+\j0.02}}$}
	&\multicolumn{1}{p{\gnumericColB}|}%
	{$\omega_{c2}= \frac{1}{0.02}$}
	&\multicolumn{1}{p{\gnumericColC}|}%
	{\gnumericPB{\centering}\gnumbox{-20}}
	&\multicolumn{1}{p{\gnumericColD}|}%
	{\gnumericPB{\raggedright}\gnumbox[l]{20-20=0}}
\\
\hhline{|-|-|-|-|}
